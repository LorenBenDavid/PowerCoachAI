      ...
      <section className="relative z-10 py-24 flex-grow">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            ...
            {/* LEFT SIDE CONTENT */}
            <div className="lg:col-span-7 space-y-8 relative mt-0">
              <h1 className="text-6xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                ...
                <div>
                  ...
                  <span className="text-primary">POWERLIFTING</span>
                </div>
                <div className="pt-2">
              ...
              <p className="text-xl text-muted-foreground w-2/3">
                Talk to our AI powerlifting coach and get personalized strength
                programs and nutrition plans tailored to maximize your lifts
              </p>
